...
SECRET_KEY = 'o_jbmozs16##*s3ndgt4akhbes&=a9t2p-3s$d99rhwk6ayjg+'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'coding_challenge/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
ASGI_APPLICATION = 'coding_challenge.asgi.application'
